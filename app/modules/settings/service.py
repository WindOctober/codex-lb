...
class SettingsService:
    ...
    async def get_settings(self) -> DashboardSettingsData:
        ...
        return DashboardSettingsData(
            ...
            ignore_five_hour_limit=row.ignore_five_hour_limit,
            ...
            kyc_routing_enforcement_enabled=bool(getattr(row, "kyc_routing_enforcement_enabled", True)),
    ...
    async def update_settings(self, payload: DashboardSettingsUpdateData) -> DashboardSettingsData:
        ...
        row = await self._repository.update(
            ...
            ignore_five_hour_limit=payload.ignore_five_hour_limit,
            ...
            kyc_routing_enforcement_enabled=payload.kyc_routing_enforcement_enabled,
